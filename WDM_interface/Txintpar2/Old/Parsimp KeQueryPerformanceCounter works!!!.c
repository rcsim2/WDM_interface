...
Abstract:
    ...
    2. (Will automatically done by 1.)
       Add and set an EnableConnectInterruptIoctl reg val to 0x1 (DWORD)
...
/*    
    ...
    // Not necessary since extension has been zeroed already
	extension->IntCount = 0;    
	extension->PrevIntTime = 0; 
	extension->GotIntTime = 0;  
	extension->PulseLength = 0; 
	extension->GotSync = 0;     
	extension->ChannelCount = 0;
	extension->SyncPulse = 0;   
	extension->Ch1 = 0;         
	extension->Ch2 = 0;         
	extension->Ch3 = 0;         
	extension->Ch4 = 0;         
