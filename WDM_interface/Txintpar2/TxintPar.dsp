...
# ADD CPP /nologo /Gz /W3 /WX /Z7 /Gy /I "i386\\" /I "." /I "..\inc" /I "..\..\inc" /I "e:\NTDDK\inc" /I "e:\NTDDK\inc\ddk" /I "e:\NTDDK\inc\ddk\wdm" /I "e:\NTDDK\private\inc" /FI"e:\NTDDK\inc\warning.h" /D _X86_=1 /D i386=1 /D "STD_CALL" /D CONDITION_HANDLING=1 /D NT_UP=1 /D NT_INST=0 /D WIN32=100 /D _NT1X_=100 /D WINNT=1 /D _WIN32_WINNT=0x0500 /D WINVER=0x0500 /D _WIN32_IE=0x0501 /D WIN32_LEAN_AND_MEAN=1 /D DBG=1 /D DEVL=1 /D FPO=0 /D "NDEBUG" /D _DLL=1 /FR /Zel -cbstring /QIfdiv- /QIf /QI0f /GF /Oxs parsimp.c /c
...
# ADD LINK32 objchk\i386\parsimp.res objchk\i386\parsimp.obj e:\NTDDK\libchk\i386\ntoskrnl.lib e:\NTDDK\libchk\i386\hal.lib e:\NTDDK\libchk\i386\wmilib.lib /nologo /base:"0x10000" /version:5.0 /stack:0x40000,0x1000 /entry:"DriverEntry@8" /incremental:no /map /machine:IX86 /nodefaultlib /out:"objchk\i386\parsimp.sys" -MERGE:_PAGE=PAGE -MERGE:_TEXT=.text -SECTION:INIT,d -OPT:REF -OPT:ICF -IGNORE:4001,4037,4039,4044,4065,4070,4078,4087,4089,4198 -FULLBUILD -FORCE:MULTIPLE -NOCOMMENT /release -debug:FULL -osversion:5.00 -optidata -driver -align:0x20 -subsystem:native,5.00
